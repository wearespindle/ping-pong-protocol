...
|Triple optional | Players have to play either a normal, always serve, or tennis hit to return the ball. The choice is their own except if mentioned otherwise at the beginning of the game. A combination of options is also allowed, such as tennis + always serve.|
